                ...
                <div class="todo">
                    ...
                    <div class="fbody">
                        <div class="container-reg">
                            ...
                            // Dynamically load the appropriate form based on content type
                            switch ($contentType) {
                                case 'users':
                                    include 'forms/usersFormE.php';
                                    break;
                                case 'movies':
                                    include 'forms/moviesFormE.php';
                                    break;
                                case 'bookings':
                                    include 'forms/bookingsFormE.php';
                                    break;
                                case 'screens':
                                    include 'forms/screensFormE.php';
                                    break;
                                default:
                                    echo "<div class=title>Invalid content type</div></div>";
                            }
