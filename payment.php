                    ...
                    <div class="tab-content">
                        <div class="row">
                           ...
                           if (mysqli_num_rows($result) > 0) {
                                ...
                                Show Name: '.$_POST['movie'].'<br>
                                Seats: '.implode(",", $_POST["seat"]).' <br>
                                Payment Date: '.date("D-d-m-y",strtotime('today')).'
                                </div>
                            <div class="col-lg-6">
                        ...
                        <div id="credit-card" class="tab-pane fade show active pt-3">
                                ...
                                <div id="msg"></div>
                                <div class="card-footer"> <button style="background-color:#f9bc50;color:#000; font-weight:bold" type="submit" id="payment" class="subscribe btn btn-primary btn-block shadow-sm"> Confirm Payment </button>
