...
<h3><center>BOOK YOUR SEAT NOW</center></h3>
   ...
   <?php
      ...
      <center><input style="background-color:#f9bc50;color:black;font-weight:bold;" type="submit" name="submit" class="btn btn-primary" value="Check Avaliable Seats"></center></form>
      <hr>
...
<div class="container">
    ...
    <div class="col-lg-6">
        ...
        <table>
            <tr><td width="50%"><font size="5px" style="font-weight: bold;">Movie:</font></td>
                <td class="golden" bgcolor="000"><center><font size=5 style="font-weight: bold;"><?php echo $_GET['movie'];?></font></center></td>
            </tr>
            <tr><td width="50%"><font size="5px" style="font-weight: bold;">Time:</font></td>
                <td class="golden" bgcolor="000"><center><font size=5 style="font-weight: bold;"><?php echo $_GET['time'];?></font></center></td>
            </tr>
            <tr><td width="50%"><font size="5px" style="font-weight: bold;">Seats:</font></td>
                <td> <input type="text" id="selectedtext" name="seats" placeholder="Selected Seats"></td>
            </tr>
            <tr><td width="50%"><font size="5px"style="font-weight: bold;">Total Seats:</font></td>
...
<div class="col-lg-12">
            <div class="form-group">
                     <a style="background-color:#f9bc50;" data-toggle="modal" data-target="#tailer_modal" class="form-control btn btn-primary py-2"><font style="font-weight:bold;">Checkout</a>
                  </div>
    </div>
...
?>
   <div class="col-lg-12">
            <div class="form-group">
                    <input style="background-color:#f9bc50;font-weight:bold;color:#000" type="submit" value="Checkout" name="submit" class="form-control btn btn-primary py-2">
                  </div>
    </div>
